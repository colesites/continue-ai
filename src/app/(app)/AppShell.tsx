  ...
  return (
    <div className="h-screen flex overflow-hidden bg-background">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        {/* Mobile Header */}
        <div className="md:hidden flex items-center p-4 border-b border-border bg-background/80 backdrop-blur shrink-0 z-40">
          <button
          ...
          <span className="font-semibold ml-2 text-foreground">Continue AI</span>
        </div>
